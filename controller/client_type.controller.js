...
exports.create = (req, res) =>{
    ...
    req.assert('client_type', 'Invalid client type').notEmpty();
    ...
    if(!errors){
        ...
        ClientType.create(
            ...
            res.status(503).send(opr.returnError("FAILED_TO_CREATE_CLIENT_TYPE"));
        })
    }
    else {
...
exports.get = (req, res) =>{
    ...
    if(!errors && req.params.id>0){
        ...
        ClientType.findOne({
            ...
            opr.writeErrorLog(e);
            res.status(403).send(opr.returnError("FAILED_TO_FETCH_CLIENT_TYPE"));
        });
    }
    else {
...
exports.getAll = (req, res) => {
    ...
    ClientType.findAll({
        ...
        opr.writeErrorLog(err);
        res.status(503).send(opr.returnError("FAILED_TO_FETCH_CLIENT_TYPE"));
    });
};
...
exports.update = (req, res) => {
    ...
    ClientType.update(
        ...
        try{
            ...
            res.status(403).send(opr.returnError("FAILED_TO_UPDATE_CLIENT_TYPE"));
        }
    });
